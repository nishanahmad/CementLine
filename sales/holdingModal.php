...
{		
	...
	$sheetQuery = mysqli_query($con,"SELECT * FROM sheets WHERE site='" . $_GET["id"] . "'") or die(mysqli_error($con));	
	...
	$arObjects = mysqli_query($con,"SELECT id,name,type,shop_name FROM clients ORDER BY name") or die(mysqli_error($con));	
	...
	$holdingQuery = mysqli_query($con,"SELECT * FROM holdings WHERE returned_sale =".$_GET['id']) or die(mysqli_error($con));
		...
		<div class="modal-content">
			...
			<input hidden name="sheetRange" value="<?php echo $urlrange;?>">		  
			  <div class="modal-body">
				  <input type="text" hidden name="returnId" id="returnId" value="<?php echo $row['id'];?>">
					<br/><br/>
