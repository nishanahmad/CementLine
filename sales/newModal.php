...
// Populate maps for SAP CODE and SHOP NAME
	...
	$arObjects = mysqli_query($con,"SELECT * FROM clients ORDER BY name ASC");
	foreach($arObjects as $arObject)
	{
		$arId = $arObject['id'];
		
		$shopName = strip_tags($arObject['shop']);
				...
				<form name="newSaleForm" id="newSaleForm" method="post" action="insert.php">
					<div class="row">
						<div class="form-group row">
							...
							<div class="col-sm-6 col-md-4 offset-md-2" id="content-desktop">
								<div class="input-group mb-3">
					...
					<div class="row">
						<div class="form-group row">
							<div class="col-sm-6 col-md-5 offset-md-1">
								<div class="input-group mb-3">
									<span class="input-group-text col-md-3"><i class="fa fa-address-card-o"></i>&nbsp;Client</span>
									<select name="client" id="client" required class="form-control" style="width:74%">
							...
							<div class="col-sm-6 col-md-4" id="content-desktop">
								<div class="input-group mb-3">
									<span class="input-group-text col-md-4 col-xs-3"><i class="fas fa-truck-moving"></i>&nbsp;Truck</span>
					...
					<div class="row">
						<div class="form-group row">
							<div class="col-sm-6 col-md-5 offset-md-1">
								<div class="input-group mb-3">
									<span class="input-group-text col-md-3"><i class="fa fa-shield"></i>&nbsp;Product</span>
					...
					<div class="row">
						<div class="form-group row">
							<div class="col-sm-6 col-md-5 offset-md-1">
								<div class="input-group mb-3">
									<span class="input-group-text col-md-3"></i>&nbsp;Remarks</span>
									<textarea name="remarks" id="remarks" class="form-control" rows="3"></textarea>
								</div>
							</div>
							<div class="col-sm-6 col-md-5" id="content-desktop">
								<div class="input-group mb-3">
									<span class="input-group-text col-md-3"><i class="fas fa-map-marker-alt"></i>&nbsp;Address</span>
					...
					<div class="row">
						<div class="form-group row">
							...
							<div class="col-sm-6 col-md-5 offset-md-2" id="content-desktop">
								<div class="input-group mb-3">
