...
if(isset($_SESSION["user_name"]))
{
	...
	<body>
		<nav class="navbar navbar-light bg-light sticky-top bottom-nav">
			...
			<span class="navbar-brand" style="font-size:25px;margin-right:50%;"><i class="fa fa-bolt"></i> Sale</span>
		</nav>
		<br/><br/>
			...
			<div style="width:100%;">
				<div align="center" style="padding-bottom:5px;">				
					<div class="card" style="width:65%;">
						<div class="card-header" style="background-color:#f2cf5b;font-size:20px;font-weight:bold;color:white">Sale <?php echo $row['id']; ?></div>
						<div class="card-body">
							<div class="row">
								<div class="col col-md-4 offset-1">
									<div class="input-group">
										<span class="input-group-text col-md-5"><i class="far fa-calendar-alt"></i>&nbsp;Date</span>
										<input type="text" required id="date" name="date" class="form-control" autocomplete="off" value="<?php
							...
							<div class="row">
								<div class="col col-md-5 offset-1">
									<div class="input-group">
										...
										<select name="client" id="client" required class="form-control" style="width:250px;" onChange="arRefresh(shopNameArray);">																	<?php
											foreach($arMap as $arId => $arName)
											{																							?>
												<option value="<?php echo $arId;?>" <?php if($row['client'] == $arId) echo 'selected';?>><?php echo $arName;?></option>														<?php	
											}																							?>
										</select>
									</div>
								</div>
