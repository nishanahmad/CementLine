...
if (strpos($url, 'trucks') !== false)
	$flag = 'loading';
if (strpos($url, 'client') !== false || strpos($url, 'points') !== false || strpos($url, 'Target') !== false)
	$flag = 'client';
...
$today = date('Y-m-d');
$sql = "SELECT * FROM sales WHERE date = '$today' ORDER BY bill_no ASC";
...
<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark sticky-top top-nav" id="content-desktop">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	<ul class="navbar-nav mr-auto">
	  ...
	  <li class="nav-item">
		<a class="nav-link" <?php if($flag == 'client') echo 'href="#"'; else echo 'href="../clients/list.php"';?>>
		  <i class="fa fa-address-card-o <?php if($flag == 'client') echo 'glow';?> aria-hidden="true"></i>
		  Clients
		</a>
	  </li>	  
	  <li class="nav-item">
