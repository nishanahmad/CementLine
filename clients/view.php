...
if(isset($_SESSION["user_name"]))
{
	...
	$urlId = $_GET['id'];
	$sql = mysqli_query($con,"SELECT * FROM clients WHERE id='$urlId'") or die(mysqli_error($con));
	$client = mysqli_fetch_array($sql,MYSQLI_ASSOC);	
...
<html>
	...
	<body>
		...
		<div align="center" style="padding-bottom:5px;">
			...
			<h2 style="margin-left:150px;" <label id="name"><?php echo $client['name'];?></label></h2>
			<div class="col-md-10 col-md-offset-1">	
				<div class="row content-panel">
					...
					<div class="right-divider" style="height:250px;">
					  ...
					  <table class="tbl">
						  <tr>
							...
							<td style="width:300px">: <?php echo $client['name'];?></td>
						  </tr>
						  <tr>
				  ...
				  <div class="col-md-4">
					<br/><br/>
					<a  href="edit.php?id=<?php echo $client['id'];?>" class="btn btn-theme" style="width:120px"><i class="fa fa-pencil"></i> Edit Client</a>
					<br/><br/>
