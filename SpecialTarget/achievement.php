...
if(isset($_SESSION["user_name"]))
{
	...
	$arList = mysqli_query($con,"SELECT id, name, mobile, shop_name FROM clients WHERE isActive = 1 AND id NOT IN ('$zeroTargetIds') AND Type LIKE '%AR%' ") or die(mysqli_error($con));		 
