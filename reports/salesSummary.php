						...
						{																										?>
							<tr id="<?php echo $arNameMap[$arSale['client']];?>">
								...
								{		
									...
									{																																			?>
										<td id="content-desktop"><button class="btn btn-sm" value="<?php echo $arSale['client'];?>" style="background-color:#228B22;color:white;" onclick="callAjax(this.value)"><i class="fas fa-check"></i> Verify</button></td>																											<?php			
									}
								}																																				?>																																
							</tr>																																				<?php	
