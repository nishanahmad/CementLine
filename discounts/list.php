...
<html>
	...
	<body>
		...
		<div style="width:100%;" class="mainbody">	
			...
			<div align="center">
				<br/><br/>
				<table class="discounttable table table-hover table-bordered" id="discounttable" style="<?php if($type=='Cash Discounts') echo 'width:60%'; else echo 'width:35%;';?>">
					<thead>
						<tr class="table-info">																						<?php 
							...
							<th style="min-width:180px;"><i class="fa fa-shield"></i> Product</th>
